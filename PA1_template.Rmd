...
## Steps per Interval
```{r interval_mean, echo=FALSE, results="hide"}
...
## NA Values
```{r navals, echo=FALSE, results="hide"}
...
```{r replacena, echo=TRUE, results="hide"}
...
```
```{r calcsteps, echo=FALSE, results="hide"}
#Calculate the total number of steps per day
...
```{r week, echo=FALSE, results="hide"}
